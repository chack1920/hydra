...
func Test_conf_Pub(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "2. 发布时,地址正确,空对象,不覆盖", fields: fields{data: map[string]iCustomerBuilder{"api": BaseBuilder{"main": "123456", "testvar1": "22222"}},
		...
		{name: "3. 发布时,地址正确,空对象,覆盖", fields: fields{data: map[string]iCustomerBuilder{"api": BaseBuilder{"main": "123456", "testvar1": "22222"}},
			vars: map[string]map[string]interface{}{"db": map[string]interface{}{"dcc": "545454"}, "cache1": map[string]interface{}{"dccsss": "5454"}}},
			args:    args{registryAddr: "lm://.", platName: "platName2", systemName: "systemName2", clusterName: "clusterName2", cover: true},
			isExsit: false, wantErr: false},
		{name: "4. 发布时,地址正确,实体对象,不覆盖", fields: fields{data: map[string]iCustomerBuilder{"api": BaseBuilder{"main": "123456", "testvar1": "22222"}},
			vars:    map[string]map[string]interface{}{"db": map[string]interface{}{"dcc": "545454"}, "cache1": map[string]interface{}{"dccsss": "5454"}},
			olddata: map[string]iCustomerBuilder{"api": BaseBuilder{"main": "{}", "testvar1": "{}"}},
		...
		{name: "5. 发布时,地址正确,实体对象,覆盖", fields: fields{data: map[string]iCustomerBuilder{"api": BaseBuilder{"main": "123456", "testvar1": "22222"}},
			vars:    map[string]map[string]interface{}{"db": map[string]interface{}{"dcc": "545454"}, "cache1": map[string]interface{}{"dccsss": "5454"}},
			olddata: map[string]iCustomerBuilder{"api": BaseBuilder{"main": "{}", "testvar1": "{}"}},
			oldvars: map[string]map[string]interface{}{"db": map[string]interface{}{"dcc": "{}"}, "cache1": map[string]interface{}{"dccsss": "{}"}}},
