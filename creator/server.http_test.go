...
func Test_httpBuilder_Static(t *testing.T) {
	tests := []struct {
		...
		{name: "1. 初始化默认static对象", fields: &httpBuilder{tp: "x1", BaseBuilder: make(map[string]interface{})}, args: []static.Option{}, want: BaseBuilder{"static": static.New("x1")}},
		{name: "2. 初始化自定义static对象", fields: &httpBuilder{tp: "x1", BaseBuilder: make(map[string]interface{})},
			...
			want: BaseBuilder{"static": static.New("x1", static.WithDisable(), static.WithAssetsPath("./sssss"))}},
		{name: "3. 重复初始化自定义static对象", fields: &httpBuilder{tp: "x1", BaseBuilder: make(map[string]interface{})},
			...
			want:   BaseBuilder{"static": static.New("x1", static.WithEnable(), static.WithAssetsPath("./xxxx"))}},
	}
	for _, tt := range tests {
